				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="cform" id="contact-form">
							<div id="sendmessage">
							Your code was submited. Thank you	 
							</div>
							<form action="submit.php" method="post" role="form" class="contactForm">
							  <div class="form-group">
								<label for="code">Enter Your Code Here!</label>
                                <textarea class="form-control" name="text" rows="30" cols="60"data-rule="required" data-msg="Please write your code.">
<?php
...
?>
							  ...
							  <div class="form-group">
                                ...
                                <textarea class="form-control" name="input" rows="4" cols="60" data-rule="required" >
<?php
...
?>
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control" name="output" rows="10" cols="60" data-rule="required" data-msg="Here's your output">
